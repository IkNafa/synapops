...
GITHUB_APP_NAME = os.environ.get("GITHUB_APP_NAME", "my-github-app")
FRONTEND_URL = os.environ.get("FRONTEND_URL")
GITHUB_PRIVATE_KEY_PATH = os.environ.get("GITHUB_PRIVATE_KEY_PATH", "/secrets/github_app_private_key.pem")
